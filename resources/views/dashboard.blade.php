        ...
        <main class="min-h-screen flex-1 lg:ml-72">
            ...
            <div class="mx-auto max-w-7xl space-y-8 p-5 sm:p-8">
                <section class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
                    @foreach ([
                        ['title' => 'Average Accuracy', 'value' => 'No Data', 'note' => 'No completed assessments yet', 'icon' => 'trending_up', 'tone' => 'primary'],
                        ['title' => 'Students With Results', 'value' => '0', 'note' => 'Waiting for progress records', 'icon' => 'group', 'tone' => 'secondary'],
                        ['title' => 'Needs Attention', 'value' => '0', 'note' => 'Interventions will appear here', 'icon' => 'warning', 'tone' => 'tertiary'],
                        ['title' => 'Total Learning Hours', 'value' => 'No Data', 'note' => 'Session totals not available yet', 'icon' => 'schedule', 'tone' => 'on-surface'],
                    ] as $card)
                ...
                <section class="grid grid-cols-1 gap-6 lg:grid-cols-12">
                    <div class="overflow-hidden rounded-lg bg-surface-container-lowest p-8 shadow-[0_10px_30px_rgba(0,0,0,0.02)] lg:col-span-8">
                        <div class="mb-6">
                            ...
                            <p class="text-sm text-on-surface-variant">Student progress will appear here after assessments are assigned and completed.</p>
                        </div>
                        ...
                        <div class="flex min-h-[18rem] flex-col items-center justify-center rounded-xl bg-surface-container-low p-8 text-center">
                            ...
                            <p class="mt-2 max-w-xl text-sm text-on-surface-variant">This dashboard stays in a default state until your students complete teacher-prepared assessments. Once real data exists, charts and summaries will update here.</p>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg bg-primary p-8 text-on-primary lg:col-span-4">
                        ...
                        <div class="space-y-5">
                            @foreach (['Literacy', 'Numeracy', 'Critical Thinking'] as $area)
                                <div>
                                    ...
                                    <div class="h-3 w-full overflow-hidden rounded-full bg-on-primary/20">
                                        <div class="h-full w-[0%] rounded-full bg-white/40"></div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="mt-10 rounded-md bg-white/10 p-4 backdrop-blur-md">
                            <p class="text-sm font-medium leading-relaxed">Assign assessments first to unlock recommendations and class-wide focus analysis.</p>
                        </div>
                    </div>
                </section>
                                ...
                                <tbody class="divide-y divide-outline-variant/5">
                                    @foreach ($students as $student)
                                        ...
                                        <tr class="group transition-colors hover:bg-surface-container-low/30">
                                            ...
                                            <td class="px-8 py-5">
                                                <span class="rounded-full bg-surface-container-high px-3 py-1 text-[10px] font-black uppercase text-on-surface-variant">No Data Yet</span>
                                            </td>
                    ...
                    <div class="rounded-lg bg-secondary p-8 text-white shadow-lg shadow-secondary/20">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-sm opacity-90">The teacher side is now showing default empty states that match the current student progress state.</p>
                            </div>
                        </div>
                    </div>
                </section>
